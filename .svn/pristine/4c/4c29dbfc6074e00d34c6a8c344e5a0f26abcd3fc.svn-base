...
//
//*****************************************************************************
extern unsigned short g_ucPhaseCurrentIndexLog;
extern unsigned long g_ulBEMFPeriod;
extern short g_psPhaseCurrent[3];
extern unsigned long g_ulPhaseBEMFCountMax;
extern unsigned short g_usBusVoltageCount;
extern unsigned short g_pusADC0DataRaw[8];
extern unsigned short g_pusBEMFVoltageCount[3];
